...
class FishCreate extends Component {
    constructor(props) {
        super(props);
        this.state = { modal: false, fishImage: "", species: "", weight: 0, length: 0, catchAndRelease: false, caption: ""}
    }
...
<i class="fas fa-fish"></i>Log a Catch</li>
      ...
      <Form onSubmit={this.handleFishCatch}>
        ...
        <ModalBody className="create-modal">
            <FormGroup>
              <FishPic image={this.state.fishImage} setImage={this.setImage}/>
            </FormGroup>
            <FormGroup>
