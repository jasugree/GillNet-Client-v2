...
<Row xs={1} lg={2} xl={3} xxl={4} className="g-4 fishCards">
  {this.props.fishes.sort((a, b ) => {
      ...
      <Card>
        ...
        <img src={(fish?.user?.profileImage) === null ? "https://camo.githubusercontent.com/c6fe2c13c27fe87ac6581b9fe289d2f071bd1b4ef6f3e3c5fc2aba0bbc23fd88/68747470733a2f2f75706c6f61642e77696b696d656469612e6f72672f77696b6970656469612f636f6d6d6f6e732f372f37632f50726f66696c655f6176617461725f706c616365686f6c6465725f6c617267652e706e67" :(fish?.user?.profileImage) }
        ...
        <CardImg variant="top" src={fish.fishImage} style={{height:"200px",objectFit: "cover", borderRadius: "none"}} />
        <CardBody>
        ...
        <div className="editButton"><EditFish fish={fish} updateFishes={this.props.updateFishes} sessionToken={this.props.sessionToken}/></div>
        <div className="deleteButton"><DeleteFish fish={fish} updateFishes={this.props.updateFishes} sessionToken={this.props.sessionToken}/></div>
        </div>
        </div>
          <CardText>{fish.caption}
